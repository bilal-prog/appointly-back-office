...
import { CalendarRange, Twitter, Facebook, Instagram, Linkedin } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-6">
              The complete scheduling and business management platform designed for service businesses.
            </p>
